<div class="page-content page-container" id="page-content" style="margin-top:100px; margin-left:400px;">
    <div class="padding">
        <div class="row container d-flex justify-content-center">
<div class="col-md-12">
            <div class="card card-bordered">
              <div class="card-header">
                <h4 class="card-title"><strong>Chat Bot</strong></h4>
              ...
              <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:700px !important;">
                <div class="media media-chat">
                  <img class="avatar" src="https://www.urbanbrush.net/web/wp-content/uploads/edd/2017/11/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7-2017-11-10-%EC%98%A4%EC%A0%84-11.08.24.png" alt="...">
